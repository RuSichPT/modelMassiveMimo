function [outputData, precodWeights] = applyPrecodRZF(inputData, estimateChannel, ermitMat, lambda)
...
%     Replace b*inv(A) with b/A - faster 
    ...
    for ii = 1:numSC
        ...
        precodWeights(ii,:,:) = (sqEstChan' * sqEstChan + ermitMat + lambda * eye(numSTS,numSTS)) \ sqEstChan';
